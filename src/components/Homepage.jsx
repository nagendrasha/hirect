    ...
    <>
      ...
      <Grid container sx={{ display: "flex", justifyContent: "center" }}>
        ...
        >
          ...
          Founders,
          <br />
          Team Leaders <br /> and Hiring Managers
        </Typography>
        <Typography
          sx={{ mt: 4, textAlign: "center", fontSize: "18px" }}
          variant="p"
        >
          Hirect simplifies the hiring process. Directly chatting with verified
          candidates matched by the AI algorithm ensures a simple, <br /> quick
          and effective hiring experience.
        </Typography>
      </Grid>
      ...
      >
        <Grid item lg={6} sx={{ alignItems: "center" }}>
          ...
          <Typography
            sx={{ mt: 4, textAlign: "center", ml: { lg: 10, sm: 0, xs: 0 } }}
          >
            We will send you a link via SMS. To download the <br /> app, simply
            open it.
          </Typography>
          <Box
            sx={{
          ...
          >
            ...
            />
            <Button
              sx={{ backgroundColor: "green", mt: 1, borderRadius: "30px" }}
              variant="contained"
            >
              Get App
            </Button>
        ...
        <Grid container>
          {trendingCat.map((item) => (
            ...
            >
              ...
              >
                <Typography
                  sx={{ fontSize: { lg: "25px", sm: "20", xs: "20" } }}
                >
                  {item.title}
                </Typography>
                <Typography
      ...
      <Grid container sx={{ p: 2 }}>
        <Grid
          item
          lg={6}
          sx={{ alignItems: "center", pl: { lg: 10, sm: 0, xs: 0 } }}
        >
          <Typography
            sx={{
              mt: 5,
          ...
          <Button
            sx={{ backgroundColor: "green", mt: 3, borderRadius: "30px",margin:'auto',display:'block' }}
            variant="contained"
          >
            Get Hired
          </Button>
        ...
        <Grid item lg={6}>
          <Image src={chat2} width={400} style={{marginTop:'10px'}}  />
        </Grid>
      </Grid>
      ...
      <Grid container sx={{ pt: 3, backgroundColor: "rgb(44, 226, 162)" }}>
        ...
        <Grid item lg={6} sx={{ alignItems: "center", pl: 10 }}>
          <Typography sx={{ mt: 10, fontWeight: "bold" }} variant="h3">
            Hire Directly with Hirect
          </Typography>
          <Typography sx={{ mt: 4 }}>
      ...
      >
        <Grid item lg={12} sx={{ display: "flex", justifyContent: "center",p:1 }}>
          <Typography
            sx={{ fontWeight: "bold", textAlign: "center", fontSize: "45px" }}
          >
        ...
        >
          {city.map((e) => (
            <Image src={e.image} style={{ margin:'auto',display:'block' }} />
          ))}
        </Grid>
